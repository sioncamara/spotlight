...
Often, I find myself asking a chatbot questions about two separate topics. I listen
to the response for one topic while the chatbot generates the response for the other.
